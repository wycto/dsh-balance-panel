...
const CSS = '' +
  ...
  '.mb-pill{box-sizing:border-box;cursor:pointer;height:32px;color:var(--dsw-alias-label-primary,#e8e8ea);background:var(--dsw-alias-button-elevated-fill,#26262b);border:1px solid var(--dsw-alias-border-l2,#3a3a42);border-radius:10px;align-items:center;gap:6px;margin:4px 0;padding:0 10px;font-family:inherit;font-size:12px;line-height:20px;display:inline-flex;white-space:nowrap;overflow:hidden;max-width:160px}' +
...
function apply(ctx) {
  ...
  slots.inject('sidebar.footer.action', () => slots.register(
    { name: 'sidebar.footer.action', id: 'model-balance', order: 20 },
    (props) => React.createElement(BalanceFooter, props),
  ))
  slots.inject('shell.overlay', () => slots.register(
    { name: 'shell.overlay', id: 'model-balance', order: 20 },
